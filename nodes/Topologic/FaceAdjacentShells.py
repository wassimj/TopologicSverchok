...
def processItem(item):
	...
	_ = topologic.FaceUtility.AdjacentShells(face, parent, shells)
	return list(shells)

replication = [("Trim", "Trim", "", 1),("Iterate", "Iterate", "", 2),("Repeat", "Repeat", "", 3),("Interlace", "Interlace", "", 4)]

class SvFaceAdjacentShells(bpy.types.Node, SverchCustomTreeNode):
	"""
	Triggers: Topologic
	Tooltip: Outputs the adjacent Shells of the input Face
	"""
	bl_idname = 'SvFaceAdjacentShells'
	bl_label = 'Face.AdjacentShells'
...
def register():
	bpy.utils.register_class(SvFaceAdjacentShells)

def unregister():
	bpy.utils.unregister_class(SvFaceAdjacentShells)
