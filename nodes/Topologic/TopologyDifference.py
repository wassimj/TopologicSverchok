...
def processItem(item):
	...
	topologyC = None
	try:
		topologyC = fixTopologyClass(topologyA.Difference(topologyB, tranDict))
	except:
		print("ERROR: (Topologic>Topology.Difference) operation failed.")
		topologyC = None
	return topologyC
...
class SvTopologyDifference(bpy.types.Node, SverchCustomTreeNode):
	...
	def process(self):
		...
		print("Difference Operation consumed "+str(round(end - start,2))+" seconds")
