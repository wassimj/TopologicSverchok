...
def processItem(item):
	...
	_ = topologic.WireUtility.AdjacentCells(wire, parent, cells)
	return list(cells)

replication = [("Trim", "Trim", "", 1),("Iterate", "Iterate", "", 2),("Repeat", "Repeat", "", 3),("Interlace", "Interlace", "", 4)]

class SvWireAdjacentCells(bpy.types.Node, SverchCustomTreeNode):
	"""
	Triggers: Topologic
	Tooltip: Outputs the adjacent Cells of the input Wire
	"""
	bl_idname = 'SvWireAdjacentCells'
	bl_label = 'Wire.AdjacentCells'
...
def register():
	bpy.utils.register_class(SvWireAdjacentCells)

def unregister():
	bpy.utils.unregister_class(SvWireAdjacentCells)
